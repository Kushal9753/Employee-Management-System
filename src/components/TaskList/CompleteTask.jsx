...
const CompleteTask = ({ data }) => {
    return (
        <div className='flex-shrink-0 h-full w-[300px] p-5 bg-green-400 rounded-xl shadow-lg transition-transform hover:scale-[1.02]'>
            ...
            <div className='mt-4'>
                <button className='w-full bg-green-700 text-white py-2 rounded cursor-not-allowed opacity-80'>
                    Completed ✅
                </button>
            </div>
        </div>
